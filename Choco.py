# -*- coding: utf-8 -*-
"""Copy of Copy of Copy of Copy of Copy of Copy of Copy of Copy of DUntitled8.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1sXyCipIzIHVKoiAdX6zp8QeSeMReIc7X
"""
...
dataset= pd.read_csv('/content/choco - choco (5).csv')
...
data = {
    ...
    'Monthly Choco': [42, 61, 35, 30, 40, 66, 82, 72, 78, 57, 80, 42, 50, 72, 53, 39, 35, 69, 79, 77, 81, 50, 70, 55, 75]
}
...
plt.plot(data_df.index, data_df['Monthly Choco'])
plt.xlabel('Date')
plt.ylabel('Value')
...
test_stationarity(data_df['Monthly Choco'])
...
stepwise_model = auto_arima(data_df['Monthly Choco'], seasonal=False, trace=True, start_p=1, start_q=1, max_p=9, max_q=9)
...
# Plot Actual Data
plt.subplot(1, 2, 1)
plt.plot(data_df.index, data_df['Monthly Choco'], color='red', label='Actual')
plt.xlabel('Month')
plt.ylabel('Value')
...
plt.plot(data_df.index, data_df['Monthly Choco'], label='Actual', color='blue')
