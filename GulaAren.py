# -*- coding: utf-8 -*-
"""Copy of Copy of Copy of Copy of Copy of Copy of DUntitled8.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Dbb8uhJUwUn38KD2iqyLrH2GrQNjh1Rx
"""
...
dataset= pd.read_csv('/content/Aren - Aren (3).csv')
...
data = {
     ...
     'Monthly Kopi Susu Gula Aren Prediction': [33, 63, 35, 30, 42, 81, 84, 79, 83, 45, 78, 35, 54, 78, 48, 40, 36, 74, 89, 73, 66, 43, 75, 38, 82]
}
...
plt.plot(data_df.index, data_df['Monthly Kopi Susu Gula Aren Prediction'])
plt.xlabel('Date')
plt.ylabel('Value')
...
test_stationarity(data_df['Monthly Kopi Susu Gula Aren Prediction'])
...
stepwise_model = auto_arima(data_df['Monthly Kopi Susu Gula Aren Prediction'], seasonal=False, trace=True, start_p=1, start_q=1, max_p=9, max_q=9)
...
# Plot Actual Data
plt.subplot(1, 2, 1)
plt.plot(data_df.index, data_df['Monthly Kopi Susu Gula Aren Prediction'], color='red', label='Actual')
plt.xlabel('Month')
plt.ylabel('Value')
...
plt.plot(data_df.index, data_df['Monthly Kopi Susu Gula Aren Prediction'], label='Actual', color='blue')
