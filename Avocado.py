# -*- coding: utf-8 -*-
"""Copy of Copy of Copy of Copy of Copy of Copy of Copy of DUntitled8.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1qdED_2n-GBfPBwZX9_GQCQakM1QCyFl7
"""
...
dataset= pd.read_csv('/content/Avocado - Avocado (3).csv')
...
data = {
    ...
    'Monthly Avocado Prediction': [23, 45, 30, 25, 32, 47, 59, 62, 52, 34, 54, 31, 38, 57, 48, 40, 29, 46, 55, 64, 61, 39, 32, 26, 47]
}
...
plt.plot(data_df.index, data_df['Monthly Avocado Prediction'])
plt.xlabel('Date')
plt.ylabel('Value')
...
#plt.figure(figsize=(10, 6))
#plt.plot(df.index, df['Monthly Kopi Susu Gula Aren Prediction'])
#plt.xlabel('Month')
#plt.ylabel('Value')
#plt.title('Original Time Series')
#plt.show()
...
test_stationarity(data_df['Monthly Avocado Prediction'])
...
stepwise_model = auto_arima(data_df['Monthly Avocado Prediction'], seasonal=False, trace=True, start_p=1, start_q=1, max_p=9, max_q=9)
...
# Plot Actual Data
plt.subplot(1, 2, 1)
plt.plot(data_df.index, data_df['Monthly Avocado Prediction'], color='red', label='Actual')
plt.xlabel('Month')
plt.ylabel('Value')
...
plt.plot(data_df.index, data_df['Monthly Avocado Prediction'], label='Actual', color='blue')
